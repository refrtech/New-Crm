...
export class MerchantsComponent implements OnInit {
  ...
  ParaArr: Array<any> = [
    ...
    {
      Title: "Store Name", titvalue: "name",
    },
    {
    ...
    {
      Title: "Category", titvalue: "cat",
    },
    {
      Title: "Sub-Category", titvalue: "subCat",
    },
    {
      Title: "Store-Type", titvalue: "type",
    },
  ...
  onChange() {
    if (this.parameters == "cat" || this.parameters == "subCat" || this.parameters == "type") {
      this.searchvalue = "";
      this.valuetype = 1;
      ...
      if (this.parameters == "subCat") {
        this.Valuearr = [
          { Title: 'Restaurants', titvalue: 'sc-food_and_beverages-restaurants' },
          { Title: 'Cafe', titvalue: 'sc-food_and_beverages-cafe' },
          { Title: 'Club and Bars', titvalue: 'sc-food_and_beverages-clubs_and_bars' },
        ]
      }
